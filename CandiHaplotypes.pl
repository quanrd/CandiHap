...
e.g.
     perl  CandiHaplotypes.pl  ./haplotypes.hmp   ./Phenotype.txt  ./test.gff  Si9g49990
     perl  CandiHaplotypes.pl  /data/lxk/GWAS/2.call.variation/4.annotation/haplotypes.hmp  /data/lxk/GWAS/mGWAS/TG/TG-mt1201.mGWAS.txt /data/sidb/Si.Ann_RNA.gff  Si9g49940
USAGE
